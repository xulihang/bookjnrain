...
public static String  _about_click() throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Sub about_Click";
 //BA.debugLineNum = 129;BA.debugLine="StartActivity(about)";
...
mostCurrent._activity.LoadLayout("scanner",mostCurrent.activityBA);
 //BA.debugLineNum = 40;BA.debugLine="Activity.AddMenuItem(\"在线工具\",\"web\")";
mostCurrent._activity.AddMenuItem("在线工具","web");
 //BA.debugLineNum = 41;BA.debugLine="Activity.AddMenuItem(\"复制到剪贴板\",\"cp\")";
mostCurrent._activity.AddMenuItem("复制到剪贴板","cp");
 //BA.debugLineNum = 42;BA.debugLine="Activity.AddMenuItem(\"上传到服务器\",\"upload\")";
mostCurrent._activity.AddMenuItem("上传到服务器","upload");
 //BA.debugLineNum = 43;BA.debugLine="Activity.AddMenuItem(\"关于\",\"about\")";
mostCurrent._activity.AddMenuItem("关于","about");
 //BA.debugLineNum = 44;BA.debugLine="Activity.AddMenuItem(\"退出\",\"Quit\")";
mostCurrent._activity.AddMenuItem("退出","Quit");
 //BA.debugLineNum = 46;BA.debugLine="Button2.Enabled=False";
mostCurrent._button2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 47;BA.debugLine="Button3.Enabled=False";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 70;BA.debugLine="zx.BeginScan(\"myzx\")";
...
anywheresoftware.b4a.samples.httputils2.httpjob _job2 = null;
 //BA.debugLineNum = 73;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 74;BA.debugLine="Dim job2 As HttpJob";
...
_job2._initialize(processBA,"Job2",main.getObject());
 //BA.debugLineNum = 76;BA.debugLine="job2.Download(\"https://api.douban.com/v2/book/isbn/:\"&result)";
_job2._download("https://api.douban.com/v2/book/isbn/:"+_result);
 //BA.debugLineNum = 77;BA.debugLine="ProgressDialogShow(\"获取数据中...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"获取数据中...");
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return "";
}
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 141;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 142;BA.debugLine="LoadJSONDATA";
_loadjsondata();
...
b4a.util.BClipboard _cc = null;
 //BA.debugLineNum = 136;BA.debugLine="Sub cp_Click";
 //BA.debugLineNum = 137;BA.debugLine="Dim CC As BClipboard";
_cc = new b4a.util.BClipboard();
 //BA.debugLineNum = 138;BA.debugLine="CC.setText(Label2.Text)";
...
mostCurrent._job1 = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 34;BA.debugLine="Dim Button3 As Button";
...
String _jresult = "";
 ...
 //BA.debugLineNum = 101;BA.debugLine="Log(\"JobName = \" & job.JobName & \", Success = \" & job.Success)";
...
anywheresoftware.b4a.keywords.Common.Log(_job._getstring());
 //BA.debugLineNum = 108;BA.debugLine="ToastMessageShow(\"上传成功！\",False)";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 111;BA.debugLine="Button3.Enabled=True";
mostCurrent._button3.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 112;BA.debugLine="Dim jresult As String";
_jresult = "";
 //BA.debugLineNum = 113;BA.debugLine="jresult = job.GetString";
_jresult = _job._getstring();
 //BA.debugLineNum = 114;BA.debugLine="sJSONData = jresult";
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 118;BA.debugLine="Log(\"Error: \" & job.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.Log("Error: "+_job._errormessage);
 //BA.debugLineNum = 119;BA.debugLine="ToastMessageShow(\"Error: \" & job.ErrorMessage, True)";
...
anywheresoftware.b4a.objects.collections.Map _map1 = null;
 //BA.debugLineNum = 80;BA.debugLine="Sub LoadJSONDATA()";
 //BA.debugLineNum = 82;BA.debugLine="Log(\"Data:\"&sJSONData)";
anywheresoftware.b4a.keywords.Common.Log("Data:"+mostCurrent._sjsondata);
 //BA.debugLineNum = 84;BA.debugLine="Dim JSON As JSONParser";
_json = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 85;BA.debugLine="JSON.Initialize(sJSONData)";
_json.Initialize(mostCurrent._sjsondata);
 //BA.debugLineNum = 86;BA.debugLine="Dim map1 As Map";
_map1 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 87;BA.debugLine="map1 = JSON.Nextobject";
_map1 = _json.NextObject();
 //BA.debugLineNum = 90;BA.debugLine="bookname = map1.GetValueAt(12)";
mostCurrent._bookname = BA.ObjectToString(_map1.GetValueAt((int) (12)));
 //BA.debugLineNum = 91;BA.debugLine="bookprice= map1.GetValueAt(13)";
mostCurrent._bookprice = BA.ObjectToString(_map1.GetValueAt((int) (13)));
 //BA.debugLineNum = 92;BA.debugLine="bookpublisher= map1.GetValueAt(9)";
mostCurrent._bookpublisher = BA.ObjectToString(_map1.GetValueAt((int) (9)));
 //BA.debugLineNum = 93;BA.debugLine="bookpubdate= map1.GetValueAt(4)";
mostCurrent._bookpubdate = BA.ObjectToString(_map1.GetValueAt((int) (4)));
 //BA.debugLineNum = 97;BA.debugLine="Label2.Text=\"条码：\"&result&CRLF&\"书名：\"&bookname&CRLF&\"价格：\"&bookprice&CRLF&\"出版社：\"&bookpublisher&CRLF&\"出版年份：\"&bookpubdate";
...
public static String  _myzx_result(String _atype,String _values) throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Sub myzx_result(atype As String,Values As String)";
 //BA.debugLineNum = 52;BA.debugLine="result=Values";
_result = _values;
 //BA.debugLineNum = 53;BA.debugLine="Label2.Text = \"结果为：\"&result";
...
public static String  _quit_click() throws Exception{
 //BA.debugLineNum = 124;BA.debugLine="Sub Quit_Click";
 //BA.debugLineNum = 125;BA.debugLine="ExitApplication";
...
long _now = 0L;
String _time = "";
 //BA.debugLineNum = 145;BA.debugLine="Sub upload_Click";
 //BA.debugLineNum = 147;BA.debugLine="ProgressDialogShow(\"上传中...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"上传中...");
 //BA.debugLineNum = 148;BA.debugLine="Dim now As Long";
_now = 0L;
 //BA.debugLineNum = 149;BA.debugLine="Dim time As String";
_time = "";
 //BA.debugLineNum = 150;BA.debugLine="now = DateTime.now";
_now = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 151;BA.debugLine="time=DateTime.GetYear(now)&\"/\"&DateTime.GetMonth(now)&\"/\"&DateTime.GetDayOfMonth(now)&\"/\"&DateTime.GetHour(now)&\"/\"&DateTime.GetMinute(now)&\"/\"";
_time = BA.NumberToString(anywheresoftware.b4a.keywords.Common.DateTime.GetYear(_now))+"/"+BA.NumberToString(anywheresoftware.b4a.keywords.Common.DateTime.GetMonth(_now))+"/"+BA.NumberToString(anywheresoftware.b4a.keywords.Common.DateTime.GetDayOfMonth(_now))+"/"+BA.NumberToString(anywheresoftware.b4a.keywords.Common.DateTime.GetHour(_now))+"/"+BA.NumberToString(anywheresoftware.b4a.keywords.Common.DateTime.GetMinute(_now))+"/";
 //BA.debugLineNum = 152;BA.debugLine="Log(time)";
anywheresoftware.b4a.keywords.Common.Log(_time);
 //BA.debugLineNum = 153;BA.debugLine="job1.Initialize(\"Job1\",Me)";
mostCurrent._job1._initialize(processBA,"Job1",main.getObject());
 //BA.debugLineNum = 154;BA.debugLine="job1.PostString(\"https://bottle-bookjnrain.rhcloud.com/login\",\"username=admin&password=admin&isbn=\"&result&\"&time=\"&time)";
...
public static String  _web_click() throws Exception{
 //BA.debugLineNum = 132;BA.debugLine="Sub web_Click";
 //BA.debugLineNum = 133;BA.debugLine="StartActivity(web)";
